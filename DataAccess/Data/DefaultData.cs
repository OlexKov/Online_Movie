...
namespace DataAccess.Data
{
	internal static class DefaultData
	{
		...
		[
			...
			//Inception screeshots
			new() { Id = 15,  MovieId = 3, Name = "9c5c4b7d933b436fa7ff5f8971d7ffb6.jpg" },
			new() { Id = 16,  MovieId = 3, Name = "05c1fa41bf324157a1df9c1eb6f556e4.jpg" },
			new() { Id = 17, MovieId = 3, Name = "bc68599bf067498bba00894694b36a41.jpg" },
			new() { Id = 18, MovieId = 3, Name = "fc1dfd25a97646ea8576c6785666dcc5.jpg" },

			//Prince of Persia screeshots
			new() { Id = 19,  MovieId = 4, Name = "4fc5360c83e548b5bda7db0d237ea701.jpg" },
			new() { Id = 20,  MovieId = 4, Name = "cc3b110a147a4bef9a04598974409199.jpg" },
			new() { Id = 21, MovieId = 4, Name = "6f91954d9fd949f690f4d9f8bba4bc0d.jpg" },
			new() { Id = 22, MovieId = 4, Name = "e97a5e1f56ab443f9484bd52fcd38325.jpg" },

			//Sherlock Holmes a screeshots
			new() { Id = 23,  MovieId = 5, Name = "8eda6b7d745644229ef6ea0830fa4034.jpg" },
			new() { Id = 24,  MovieId = 5, Name = "88acda2dbc9741a08fcc66a288edf169.jpg" },
			new() { Id = 25, MovieId = 5, Name = "3b4eed90465840c78b5160d8613b4350.jpg" },
		...
		[
			...
			new()
			{
				...
				Poster = "51f300c29fc949b3a2e005f56fbcaa5f.jpeg",
				CountryId = 2,
			...
			new()
			{
				...
				Poster = "9c5c4b7d933b436fa7ff5f8971d7ffb6.webp",
				CountryId = 2,
			...
			new()
			{
				...
				Poster = "d4cfbb16be9b4ae384a612d336e18bdb.jpeg",
				CountryId = 2,
			...
			new()
			{
				...
				Poster = "3d1d88ddddaa4dafaad6da31477b6ef6.jpg",
				CountryId = 2,
		...
		[
			...
			new()
			{
				...
				ImageName = "7bb3ad83cc8f486296ad7953dcdc8985.jpeg",
				CountryId = 2,
			...
			new()
			{
				...
				ImageName = "8302c710ae0c4ff2aa68c7d41d4ea7955.jpg",
				CountryId = 20,
