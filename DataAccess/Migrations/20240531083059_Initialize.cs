...
namespace DataAccess.Migrations
{
    ...
    public partial class Initialize : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "AspNetUsers",
                columns: new[] { "Id", "AccessFailedCount", "Birthdate", "ConcurrencyStamp", "Email", "EmailConfirmed", "LockoutEnabled", "LockoutEnd", "Name", "NormalizedEmail", "NormalizedUserName", "PasswordHash", "PhoneNumber", "PhoneNumberConfirmed", "PremiumEndDate", "PremiumId", "SecurityStamp", "Surname", "TwoFactorEnabled", "UserName" },
                values: new object[,]
                {
                    { "028582c83a914a45b330b5234f4131fb", 0, new DateTime(1999, 7, 7, 0, 0, 0, 0, DateTimeKind.Unspecified), "f3797469-ab42-430c-aa3e-c7bab7223b60", "User3@gmail.com", true, false, null, "Олег", "USER3@GMAIL.COM", "USER3@GMAIL.COM", "AQAAAAIAAYagAAAAEFS8f6MoZAegBdtk3JhofmQgJdhc5Xh1ketAVBZMZVyXGKv8kcYTmRw3JUYOFEuDYg==", null, false, new DateTime(2024, 6, 2, 8, 30, 58, 665, DateTimeKind.Utc).AddTicks(2301), 3, "b13d5eba-291d-40da-8068-2b032c62e7f8", "Панасенко", false, "User3@gmail.com" },
                    { "c86dc56aedf549f6afe5ceb4d414ebf1", 0, new DateTime(2000, 11, 5, 0, 0, 0, 0, DateTimeKind.Unspecified), "e86d612f-3b39-4470-888d-622c9fd34e11", "User2@gmail.com", true, false, null, "Петро", "USER2@GMAIL.COM", "USER2@GMAIL.COM", "AQAAAAIAAYagAAAAEP2zIf/iesA+jinQxIGnX5alHUYTzP8Cp5GRSN7RREhaV0KwNVptJ6CMFxcFg9/YIA==", null, false, new DateTime(2024, 6, 2, 8, 30, 58, 575, DateTimeKind.Utc).AddTicks(9424), 2, "95676927-6c06-4268-902e-05c7f85d41d8", "Дякуленко", false, "User2@gmail.com" },
                    { "d1901b2435594da2a255db13fc57509b", 0, new DateTime(1988, 10, 14, 0, 0, 0, 0, DateTimeKind.Unspecified), "c86bb091-2696-4098-996e-b07c9d12350d", "User1@gmail.com", true, false, null, "Iван", "USER1@GMAIL.COM", "USER1@GMAIL.COM", "AQAAAAIAAYagAAAAEAltaG+iSaSXjUiptdvrg6n8b9ps0Nt8Rim8u9Jm9be4w1q8uB/OB3gPrcdbuRGCSg==", null, false, new DateTime(2024, 6, 2, 8, 30, 58, 473, DateTimeKind.Utc).AddTicks(2247), 1, "96de0aad-dc13-4d87-a170-19946f0e9517", "Калита", false, "User1@gmail.com" },
                    { "eb05f9548a2c4cf8adcc2be7305fc732", 0, new DateTime(2001, 6, 9, 0, 0, 0, 0, DateTimeKind.Unspecified), "14847cda-ecaa-4643-9a22-bfddf1c95a06", "User4@gmail.com", true, false, null, "Тимофій", "USER4@GMAIL.COM", "USER4@GMAIL.COM", "AQAAAAIAAYagAAAAEKTNi1eqv4JEAj6fBZ1x2vTbexMMVoMnnEzRmkKoC4wldLYkAGLDQs+aTvPy7f7Utw==", null, false, new DateTime(2024, 6, 2, 8, 30, 58, 754, DateTimeKind.Utc).AddTicks(5067), 2, "7d51eb30-122a-4fc0-889e-e3cad2477448", "Гнатенко", false, "User4@gmail.com" },
                    { "f66e492517d7414495e988c4c50fd107", 0, new DateTime(1998, 1, 12, 0, 0, 0, 0, DateTimeKind.Unspecified), "a8cd04be-054c-43be-904a-357036f49c2e", "Admin@gmail.com", true, false, null, "Петро", "ADMIN@GMAIL.COM", "ADMIN@GMAIL.COM", "AQAAAAIAAYagAAAAEGdj2nDGAHzUtuHoRP/xy41fUCWLI5FL8DexrMYOvx9ok0MxZWzlWNipEXjL+KTeRw==", null, false, new DateTime(2024, 6, 2, 8, 30, 58, 354, DateTimeKind.Utc).AddTicks(6286), 1, "244c0b46-749e-4cf7-939a-4c28c61c138e", "Левак", false, "Admin@gmail.com" }
                });
